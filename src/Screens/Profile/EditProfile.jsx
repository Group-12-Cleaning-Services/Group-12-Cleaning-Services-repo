  ...
  return (
    ...
    <SafeAreaView style={container}>
      ...
      <View style={welcomeContainer}>
        ...
        <Text style={welcomeText}>Changes made to this file can be change again</Text>
      </View>
      <View style={inputContainer}>
        <View style={input}>
          <Feather name={'lock'} size={20} color={'black'} style={iconUser} />
          <TextInput placeholder="Full Name" secureTextEntry />
        </View>
        <View style={input}>
          <Feather name={'lock'} size={20} color={'black'} style={iconUser} />
          <TextInput placeholder="Username" secureTextEntry />
        </View>
        <View style={input}>
          <Feather name={'phone'} size={20} color={'black'} style={iconUser} />
          <TextInput placeholder="Phone" secureTextEntry />
        </View>
      </View>
